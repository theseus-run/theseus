...
test("Link", () =>
  eq(
    render(jsx(Link, { href: "https://example.com", children: "click" })),
...
test("Escape — metacharacters escaped", () =>
  eq(render(jsx(Escape, { children: "**bold**" })), "\\*\\*bold\\*\\*"));
test("Escape — plain text unchanged", () =>
  eq(render(jsx(Escape, { children: "hello" })), "hello"));
...
test("Ol + Li (numbered)", () => {
  const node = jsx(Ol, {
    children: jsxs(Fragment, {
      children: [jsx(Li, { children: "first" }), jsx(Li, { children: "second" })],
    }),
  });
  ...
  const node = jsx(Table, {
    children: jsxs(Fragment, {
      children: [
        jsx(Tr, {
          children: jsxs(Fragment, {
            children: [jsx(Th, { children: "Name" }), jsx(Th, { children: "Val" })],
          }),
        }),
        jsx(Tr, {
          children: jsxs(Fragment, {
            children: [jsx(Td, { children: "a" }), jsx(Td, { children: "b" })],
          }),
        }),
      ],
    }),
...
test("TaskList + Task", () => {
  const node = jsx(TaskList, {
    children: jsxs(Fragment, {
      children: [jsx(Task, { children: "todo" }), jsx(Task, { done: true, children: "done" })],
    }),
  });
  eq(render(node), "- [ ] todo\n- [x] done\n\n");
});
...
const _runtime = typeof Bun !== "undefined" ? `Bun ${Bun.version}` : `Node ${process.version}`;
if (failed > 0) {
  process.exit(1);
} else {
}
