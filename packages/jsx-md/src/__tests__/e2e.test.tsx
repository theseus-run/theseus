...
import {
  H1, H2, H3,
  P, Hr, Codeblock, Blockquote,
  Ul, Ol, Li,
  Bold, Code, Italic, Link, Img,
  Table, Tr, Th, Td,
  TaskList, Task,
  Callout,
  HtmlComment,
    ...
    const doc = render(
      <>
        ...
        <Table>
          ...
          <Tr><Td>search</Td><Td>Look up information</Td></Tr>
          <Tr><Td>code</Td><Td>Execute code snippets</Td></Tr>
        </Table>
        <H2>Output Format</H2>
        <Codeblock lang="json">{'{\n  "answer": "...",\n  "confidence": 0.9\n}'}</Codeblock>
      </>
  ...
  test('H1 + versioned H2 sections with Ul + Bold + Code inline + Hr separator', () => {
    const doc = render(
      <>
        ...
        <H2>v2.0.0</H2>
        <Ul>
          <Li><Bold>Breaking</Bold>: removed <Code>legacyMode</Code> flag</Li>
          <Li>Added <Code>render()</Code> recursive component support</Li>
          <Li>Fixed <Italic>context leak</Italic> between sibling subtrees</Li>
        </Ul>
        <Hr />
        <H2>v1.0.0</H2>
        <Ul>
  ...
  test('Details + TaskList with mixed done/undone Tasks with Bold labels', () => {
    const doc = render(
      <Details summary="Sprint tasks">
        <TaskList>
          <Task done><Bold>write failing tests</Bold></Task>
          <Task done><Bold>implement feature</Bold></Task>
...
describe('e2e: table with Link and Img in cells', () => {
  test('resource table — Img in one column, Link in another', () => {
    const doc = render(
      <Table>
        <Tr><Th>Resource</Th><Th>Logo</Th><Th>Link</Th></Tr>
        <Tr>
          <Td>Bun</Td>
          <Td><Img src="bun.png" alt="Bun logo" /></Td>
          <Td><Link href="https://bun.sh">bun.sh</Link></Td>
        </Tr>
        <Tr>
          <Td>TypeScript</Td>
          <Td><Img src="ts.png" alt="TS logo" /></Td>
          <Td><Link href="https://typescriptlang.org">typescriptlang.org</Link></Td>
        </Tr>
      </Table>
    );
    ...
    const doc = render(
      <>
        ...
        <Table>
          ...
          <Tr><Td>GET</Td><Td><Code>/users/:id</Code></Td><Td>Fetch user by ID</Td></Tr>
          <Tr><Td>POST</Td><Td><Code>/users</Code></Td><Td>Create a new user</Td></Tr>
        </Table>
        <Blockquote>
          <Callout type="caution">
            <P>The <Code>POST /users</Code> endpoint is deprecated.</P>
          </Callout>
        </Blockquote>
      </>
    );
...
describe('e2e: documentation section', () => {
  test('H3 + P + Codeblock with indent + P — typical API doc shape', () => {
    const doc = render(
      <>
        <H3>Usage</H3>
        <P>Import and call <Code>render()</Code> with your JSX tree:</P>
