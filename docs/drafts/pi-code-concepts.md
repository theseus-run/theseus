...
should translate the useful mechanics into its own [architecture](../runtime/architecture.md),
[primitives](../primitives/primitives.md), [mission-system](../runtime/mission-system.md), and [isolation](../runtime/isolation.md) model.
...
These fit Theseus better than Pi because [mission-system](../runtime/mission-system.md) and Capsule give them
...
This matches [isolation](../runtime/isolation.md): Sandbox is execution isolation, Workspace is source
state inside it.
